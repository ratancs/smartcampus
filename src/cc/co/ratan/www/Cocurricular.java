...
public class Cocurricular extends ListActivity {
	@Override
    ...
    try{
          ArrayList<HashMap<String, String>> mylist = new ArrayList<HashMap<String, String>>();
             ...
             JSONObject json = JSONfunctions.getJSONfromURL("http://ratan.co.cc/msgjson.php");
             
              	JSONArray  message = json.getJSONArray("Co-curricular");
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
        	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {        		
        		...
        		Toast.makeText(Cocurricular.this, "" + o.get("subject"), Toast.LENGTH_LONG).show();
        		Intent in = new Intent(Cocurricular.this, Post.class);
        	try{	
