...
public class Secondhandselling extends ListActivity{
		@Override
		protected void onCreate(Bundle savedInstanceState) {
			// TODO Auto-generated method stub
			super.onCreate(savedInstanceState);
			setContentView(R.layout.secondhandselling);
	        
	    try{
	          ArrayList<HashMap<String, String>> mylist = new ArrayList<HashMap<String, String>>();
	             
	             JSONObject json = JSONfunctions.getJSONfromURL("http://ratan.co.cc/secondhandsellingjson.php");
	             
	              	JSONArray  message = json.getJSONArray("Second-Hand-Selling");
	        ...
	        lv.setOnItemClickListener(new OnItemClickListener() {
	        	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {        		
	        		...
	        		Toast.makeText(Secondhandselling.this, "" + o.get("subject"), Toast.LENGTH_LONG).show();
	        		Intent in = new Intent(Secondhandselling.this, Post.class);
	        	try{	
	        		...
	        		in.putExtra("cat", "Second-Hand-Selling");
	        		startActivity(in);
	        	}catch (Exception e) {
